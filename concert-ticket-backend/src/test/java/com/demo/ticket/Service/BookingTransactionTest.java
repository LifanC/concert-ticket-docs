...
//        jdbc.update("INSERT INTO interviewworks_ticket.session_seat (session_id, seat_id, status, reserved_by_order, reserved_until) SELECT session_id, seat, 'RESERVED', orderno, expires_at FROM interviewworks_ticket.ticket WHERE orderno = 'O1'");
//        var factory = new SqlSessionFactoryBean();
//        factory.setDataSource(ds);
//        factory.setMapperLocations(new ClassPathResource("Mapper/BookingMapper.xml"), new ClassPathResource("Mapper/BookingCoreMapper.xml"));
